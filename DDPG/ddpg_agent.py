...
class DDPGagent(object):
    ...
    def train(self, max_episode_num):
        ...
        for ep in range(int(max_episode_num)):
            ...
            #print('Now save')
            self.actor.save_weights("/home/backgom2357/workplace/math_RL/DDPG/save_weights/pendulum_actor.h5")
            self.critic.save_weights("/home/backgom2357/workplace/math_RL/DDPG/save_weights/pendulum_critic.h5")

        np.savetxt('/home/backgom2357/workplace/math_RL/DDPG/save_weights/pendulum_epi_reward.txt', self.save_epi_reward)
